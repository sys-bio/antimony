...
bool UnitDef::GetNameAutoGenerated() const
{
  return m_nameautogenerated;
}

bool UnitDef::IsEmpty() const
{
...
bool UnitDef::ComponentsMatch(UnitDef* unitdef) const
{
...
const UnitElement* UnitDef::GetUnitElement(unsigned long n) const
{
