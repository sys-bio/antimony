...
void Module::CreateSBMLModel()
{
  ...
  sbmlmod->setNotes("<body xmlns=\"http://www.w3.org/1999/xhtml\"><p> Originally created by libAntimony " LIBANTIMONY_VERSION_STRING " (using libSBML " LIBSBML_DOTTED_VERSION ") </p></body>");
