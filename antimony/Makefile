...
antimony : antimony.tab.o antimony_api.o formula.o module.o rd_type.o reactantlist.o reaction.o registry.o sbmlx.o stringx.o variable.o Antimony.o
	g++ -o antimony -lm $(CPPFLAGS) $(LIBRARYFLAGS) antimony.tab.o antimony_api.o formula.o module.o rd_type.o reactantlist.o reaction.o registry.o sbmlx.o stringx.o variable.o Antimony.o
...
module.o : module.cpp module.h variable.h reaction.h sbmlx.h
