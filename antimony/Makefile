...
antimony : antimony.tab.o antimony_api.o event.o formula.o module.o rd_type.o reactantlist.o reaction.o registry.o sbmlx.o stringx.o variable.o Antimony.o
	g++ -o antimony -lm $(CPPFLAGS) $(LIBRARYFLAGS) antimony.tab.o antimony_api.o event.o formula.o module.o rd_type.o reactantlist.o reaction.o registry.o sbmlx.o stringx.o variable.o Antimony.o

antimony.tar.gz : antimony.ypp antimony.tab.cpp antimony_api.cpp antimony_api.h event.cpp event.h formula.cpp formula.h libutil.h module.cpp module.h rd_type.cpp rd_type.h reactantlist.cpp reactantlist.h reaction.cpp reaction.h registry.cpp registry.h sbmlx.cpp sbmlx.h stringx.cpp stringx.h variable.cpp variable.h Antimony.cpp Makefile documentation.txt 
	tar -cvf antimony.tar antimony.ypp antimony.tab.cpp antimony_api.cpp antimony_api.h event.cpp event.h formula.cpp formula.h libutil.h module.cpp module.h rd_type.cpp rd_type.h reactantlist.cpp reactantlist.h reaction.cpp reaction.h registry.cpp registry.h sbmlx.cpp sbmlx.h stringx.cpp stringx.h variable.cpp variable.h Antimony.cpp Makefile documentation.txt
	gzip -f antimony.tar
...
variable.o : variable.cpp variable.h module.h rd_type.h registry.h event.h formula.h reaction.h
